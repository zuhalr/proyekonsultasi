...
class Ion_auth
{
	...
	public function cekOtorisasi($id,$nama_menu)
	{
		$this->load->model("M_crud","crudheader");
        $cek = count($this->crudheader->cekOtorisasiUser($id,$nama_menu)->result());
        return $cek;
	}

	public function logsActivity($id_user,$message){

		$this->load->model("M_crud","crudlog");
		...
		$this->crudlog->allInsertSave($data,"logs");
	}
